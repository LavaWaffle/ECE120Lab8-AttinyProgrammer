...
This repository stores the code for ECE120's lab Attiny13A and a Arduino Uno programmer to program each Attiny13A if any are broken.
...
Now connect the Computer to the Arduino Uno and press the Upload Button at the bottom of the screen <code>-></code>. (This will Build and Upload the Arduino Uno Programmer Code to the Arduino Uno so it can flash the Attiny13As with the lab 8 program)
